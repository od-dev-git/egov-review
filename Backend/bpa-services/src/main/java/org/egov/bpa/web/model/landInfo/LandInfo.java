...
public class LandInfo   {
  ...
  private String newOwnershipMajorType = null;
  
  @JsonProperty("newOwnershipCategory")
  private String newOwnershipCategory = null;
  
  @JsonProperty("gpaOwnershipMajorType")
  private String gpaOwnershipMajorType = null;
  
  @JsonProperty("gpaOwnershipCategory")
  private String gpaOwnershipCategory = null;
  ...
  private List<NewOwnerInfo> newOwners = new ArrayList<NewOwnerInfo>();
  
  @JsonProperty("gpaHolders")
  private List<NewOwnerInfo> gpaHolders = new ArrayList<NewOwnerInfo>();
  ...
  **/
  ...
  public LandInfo newOwnershipCategory(String newOwnershipCategory) {
	    this.newOwnershipCategory = newOwnershipCategory;
	    return this;
	  }
  
  public LandInfo gpaOwnershipCategory(String gpaOwnershipCategory) {
	    this.gpaOwnershipCategory = gpaOwnershipCategory;
	    return this;
	  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, landInfo.id) &&
        ...
        Objects.equals(this.owners, landInfo.newOwners) &&
        Objects.equals(this.owners, landInfo.gpaHolders) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, landUId, landUniqueRegNo, tenantId, status, address, ownershipCategory, newOwnershipCategory, gpaOwnershipCategory, newOwnershipMajorType, gpaOwnershipMajorType,  owners, newOwners, gpaHolders,institution, source, channel, documents, unit, additionalDetails, auditDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("    newOwnershipCategory: ").append(toIndentedString(newOwnershipCategory)).append("\n");
    sb.append("    gpaOwnershipCategory: ").append(toIndentedString(gpaOwnershipCategory)).append("\n");
    sb.append("    newOwnershipMajorType: ").append(toIndentedString(newOwnershipMajorType)).append("\n");
    sb.append("    gpaOwnershipMajorType: ").append(toIndentedString(gpaOwnershipMajorType)).append("\n");
    sb.append("    owners: ").append(toIndentedString(owners)).append("\n");
    sb.append("    newowners: ").append(toIndentedString(newOwners)).append("\n");
    sb.append("    gpaHolders: ").append(toIndentedString(gpaHolders)).append("\n");
  ...
  private String toIndentedString(java.lang.Object o) {
	...
	public String getNewOwnershipMajorType() {
		return newOwnershipMajorType;
	}

	public void setNewOwnershipMajorType(String newOwnershipMajorType) {
		this.newOwnershipMajorType = newOwnershipMajorType;
	}

	public String getNewOwnershipCategory() {
		return newOwnershipCategory;
	}

	public void setNewOwnershipCategory(String newOwnershipCategory) {
		this.newOwnershipCategory = newOwnershipCategory;
	}

	public String getGpaOwnershipMajorType() {
		return gpaOwnershipMajorType;
	}

	public void setGpaOwnershipMajorType(String gpaOwnershipMajorType) {
		this.gpaOwnershipMajorType = gpaOwnershipMajorType;
	}

	public String getGpaOwnershipCategory() {
		return gpaOwnershipCategory;
	}

	public void setGpaOwnershipCategory(String gpaOwnershipCategory) {
		this.gpaOwnershipCategory = gpaOwnershipCategory;
	}

	public List<NewOwnerInfo> getNewOwners() {
		return newOwners;
	}

	public void setNewOwners(List<NewOwnerInfo> newOwners) {
		this.newOwners = newOwners;
	}

	public List<NewOwnerInfo> getGpaHolders() {
		return gpaHolders;
	}

	public void setGpaHolders(List<NewOwnerInfo> gpaHolders) {
		this.gpaHolders = gpaHolders;
	}
}
