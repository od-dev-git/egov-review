...
public class BPA   {
  ...
  @JsonProperty("edcrData")
  @Valid
  private EdcrData edcrData = null;
  ...
  @JsonProperty("planDscDetails")
  @Valid
  private List<DscDetails> planDscDetails = null;
  
  @JsonProperty("isRevalidationApplication")
  private boolean isRevalidationApplication = Boolean.FALSE;
  
  @JsonProperty("permitExpiryDate")
  private Long permitExpiryDate = null;

  @JsonProperty("isOCOutsideSujogApplication")
  @Builder.Default
  private Boolean isOCOutsideSujogApplication=Boolean.FALSE;

  @JsonProperty("outsideOCDetails")
  @Builder.Default
  private OutsideOCDetails outsideOCDetails = new OutsideOCDetails();

  @JsonProperty("permitEdcrDetail")
  private CustomEdcrDetail permitEdcrDetail;

  @JsonProperty("ocEdcrDetail")
  private CustomEdcrDetail ocEdcrDetail;
  ...
  @JsonProperty("isNoticeExist")
  private boolean isNoticeExist = Boolean.FALSE;
  ...
  **/
  ...
  public BPA edcrData(EdcrData edcrData) {
	    this.edcrData = edcrData;
	    return this;
	  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, BPA.id) &&
        ...
        Objects.equals(this.isRevalidationApplication, BPA.isRevalidationApplication) &&
        Objects.equals(this.correlationId, BPA.correlationId)&&
        Objects.equals(this.isNoticeExist, BPA.isNoticeExist);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, applicationNo, approvalNo, accountId, edcrNumber, riskType, landId, tenantId, status, documents, landInfo, workflow, auditDetails, additionalDetails,reWorkHistory,isRevisionApplication,isRevalidationApplication,correlationId, isNoticeExist);
  }
  ...
  public String toString() {
    ...
    sb.append("    isRevalidationApplication: ").append(toIndentedString(isRevalidationApplication)).append("\n");
    sb.append("    edcrData: ").append(toIndentedString(edcrData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  private String toIndentedString(java.lang.Object o) {
	...
	public BPA addPlanDscDetailsItem(DscDetails planDscDetailsItem) {
		if (this.planDscDetails == null) {
			this.planDscDetails = new ArrayList<>();
		}
		if (!this.planDscDetails.contains(planDscDetailsItem))
			this.planDscDetails.add(planDscDetailsItem);
		return this;
	}
	...
	public EdcrData getEdcrData() {
		return edcrData;
	}

	public void setEdcrData(EdcrData edcrData) {
		this.edcrData = edcrData;
	}

	public boolean isRevalidationApplication() {
		return isRevalidationApplication;
	}

	public void setRevalidationApplication(boolean isRevalidationApplication) {
		this.isRevalidationApplication = isRevalidationApplication;
	}

	public Long getApprovalExpiryDate() {
		return permitExpiryDate;
	}

	public void setApprovalExpiryDate(Long permitExpiryDate) {
		this.permitExpiryDate = permitExpiryDate;
	}

	public BPA isRevalidationApplication(boolean isRevalidationApplication) {
		this.isRevalidationApplication = isRevalidationApplication;
		return this;
	}

	public BPA permitExpiryDate(Long permitExpiryDate) {
		this.permitExpiryDate = permitExpiryDate;
		return this;
	}

    public Boolean getOCOutsideSujogApplication() {
        return isOCOutsideSujogApplication;
    }

    public void setOCOutsideSujogApplication(Boolean OCOutsideSujogApplication) {
        isOCOutsideSujogApplication = OCOutsideSujogApplication;
    }

    public OutsideOCDetails getOutsideOCDetails() {
        return outsideOCDetails;
    }

    public void setOutsideOCDetails(OutsideOCDetails outsideOCDetails) {
        this.outsideOCDetails = outsideOCDetails;
    }

    public CustomEdcrDetail getPermitEdcrDetail() {
        return permitEdcrDetail;
    }

    public void setPermitEdcrDetail(CustomEdcrDetail permitEdcrDetail) {
        this.permitEdcrDetail = permitEdcrDetail;
    }

    public CustomEdcrDetail getOcEdcrDetail() {
        return ocEdcrDetail;
    }

    public void setOcEdcrDetail(CustomEdcrDetail ocEdcrDetail) {
        this.ocEdcrDetail = ocEdcrDetail;
    }

	public List<PlinthApproval> getPlinthApproval() {
		return plinthApproval;
	}

	public void setPlinthApproval(List<PlinthApproval> plinthApproval) {
	...
	/**
	 * @return the planDscDetails
	 */
	public List<DscDetails> getPlanDscDetails() {
		return planDscDetails;
	}

	/**
	 * @param planDscDetails the planDscDetails to set
	 */
	public void setPlanDscDetails(List<DscDetails> planDscDetails) {
		this.planDscDetails = planDscDetails;
	}
	...
	public void setNoticeExist(boolean isNoticeExist) {
		this.isNoticeExist = isNoticeExist;
	}
