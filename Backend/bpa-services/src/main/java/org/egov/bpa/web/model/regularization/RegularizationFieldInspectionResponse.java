...
@Getter
@Setter
public class RegularizationFieldInspectionResponse {

	@JsonProperty("ResponseInfo")
	private ResponseInfo responseInfo;

	@JsonProperty("fieldInspection")
	private List<RegularizationFieldInspection> fieldInspection;

	public RegularizationFieldInspectionResponse responseInfo(ResponseInfo responseInfo) {
	...
	public RegularizationFieldInspectionResponse feildInspectionResponse(List<RegularizationFieldInspection> fieldInspection) {
	...
	public boolean equals(java.lang.Object object) {
		...
		RegularizationFieldInspectionResponse fieldInspectionResponse = (RegularizationFieldInspectionResponse) object;
