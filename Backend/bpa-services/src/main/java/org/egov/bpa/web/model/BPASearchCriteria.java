...
public class BPASearchCriteria {
	 ...
	 @JsonProperty("tenantId")
	    ...
	    @JsonProperty("escalatedToMe")
        private boolean escalatedToMe;
        
        @JsonProperty("aboutToEscalate")
        private boolean aboutToEscalate;
        
        @JsonProperty("escalated")
        private boolean escalated;
        
        @JsonProperty("isRevalidationApplication")
        private Boolean isRevalidationApplication;
		...
		@JsonProperty("oldPermitNumber")
		private String oldPermitNumber;
	    ...
	    public boolean isEmpty() {
	        return (this.tenantId == null && this.status == null && this.ids == null && this.applicationNo == null
	                ...
	                && this.businessService == null && this.oldPermitNumber == null
	        );
	    }
