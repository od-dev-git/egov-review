...
public class OCConstants {
    ...
    public static final String OC_OUTSIDESUJOG_BUSSINESS_SERVICE_1 = "BPA_OC_OS1";

    public static final String OC_OUTSIDESUJOG_BUSSINESS_SERVICE_2 = "BPA_OC_OS2";

    public static final String OC_OUTSIDESUJOG_BUSSINESS_SERVICE_3 = "BPA_OC_OS3";

    public static final String OC_OUTSIDESUJOG_BUSSINESS_SERVICE_4 = "BPA_OC_OS4";
