...
public class AssessmentController {
	...
	public ResponseEntity<AssessmentResponse> create(@Valid @RequestBody AssessmentRequest assessmentRequest) {
		...
		Assessment assessment = assessmentService.createAssessment(assessmentRequest, assessmentRequest.getAssessment().getSkipWorkflow());
	...
	public ResponseEntity jobscheduler(@Valid @RequestBody BulkAssesmentCreationCriteriaWrapper bulkAssesmentCreationCriteriaWrapper ) {
		assessmentService.createbulkAssessment(bulkAssesmentCreationCriteriaWrapper);
