...
public class PTConstants {
	...
	public static final String WF_STATUS_SENT_BACK_TO_CITIZEN = "SENT_BACK_TO_CITIZEN";
    ...
    public static final String WF_STATUS_SENT_BACK_TO_CITIZEN_LOCALE = "PT_NOTIF_WF_STATE_LOCALE_SENT_BACK_TO_CITIZEN";
    ...
    public static final String PT_APPROVER_ROLE_CODE = "PT_APPROVER";
    
    public static final String EMAIL_SUBJECT_KEY = "<%application no%>";
