...
public class TranslationService {
	...
	public Map<String, Object> translateForBulkAssessment(List<AssessmentRequest> assessmentRequests){
		RequestInfo requestInfo = assessmentRequests.get(0).getRequestInfo();
		List<Map<String, Object>> calculationCriterias = new ArrayList<Map<String,Object>>();
		
		calculationCriterias = assessmentRequests.parallelStream().map(assessmentRequest -> {
			Property property = assessmentRequest.getProperty();
	        Assessment assessment = assessmentRequest.getAssessment();
        ...
        Map<String, Object> calculationReq = new HashMap<>();
        calculationReq.put("RequestInfo", requestInfo);
        calculationReq.put("CalculationCriteria", calculationCriterias);
