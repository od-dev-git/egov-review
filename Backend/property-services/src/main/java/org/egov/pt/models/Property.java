...
public class Property extends PropertyInfo {
	...
	@JsonProperty("isUpdateDataFieldRequest")
	private Boolean isUpdateDataFieldRequest;
	...
	public Property(String id, String propertyId, String surveyId, List<String> linkedProperties, String tenantId,
			...
			JsonNode additionalDetails, AuditDetails auditDetails, ProcessInstance workflow, String ddnNo, String legacyHoldingNo, Boolean isUpdateDataFieldRequest) {
		...
		this.ddnNo=ddnNo;
		this.legacyHoldingNo=legacyHoldingNo;
		this.isUpdateDataFieldRequest=isUpdateDataFieldRequest;
	}
