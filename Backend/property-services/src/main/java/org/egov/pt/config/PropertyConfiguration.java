...
public class PropertyConfiguration {
    ...
    @Value("${persister.update.datafield.topic}")
    private String updateDataFieldTopic;
	...
	@Value("${kafka.topics.bulkAssessment.create}")
	private String bulkAssessmentCreateTopic;
	
	@Value("${pt.payment.issuefix}")
	private Boolean ptPaymentIssueFIx;
	
	@Value("${assessment.jobscheduler.exemption.allowed}")
	private Boolean isULBSExceptionAllowed;
	
	@Value("${assessment.jobscheduler.exemption.ulbs}")
	private String exemptedULBS;
	
	@Value("${pt.issuefix.rolecode}")
	private String ptIssueFixRoleCode;

	@Value("${pt.issuefix.tenantid}")
	private String ptIssueFixTenantId;

	@Value("${pt.issue.resolver.uuid}")
	private String ptIssueFixUUID;
	
	@Value("${pt.status.mismatch.issuefix}")
	private Boolean ptStatusMismatchIssueFIx;
	
	@Value("${home.page.notification}")
