...
public class Constants {
	...
	public static final List<String> ADVANCE_TAXHEADS = Arrays.asList("SW_ADVANCE_CARRYFORWARD", "WS_ADVANCE_CARRYFORWARD","PT_ADVANCE_CARRYFORWARD");
	
	public static final List<String> ADVANCE_ALLOWED_BUSINESS_SERVICES = Arrays.asList("WS", "PT");

	
	/*
	 * Demand Notification
	 */
	public static final List<String> ALLOWED_BUSINESSSERVICE_FOR_DEMAND_NOTIFICATION = Arrays.asList("WS","PT");
