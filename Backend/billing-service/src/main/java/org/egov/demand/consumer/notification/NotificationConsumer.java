...
public class NotificationConsumer {
	...
	public String getPeriod(Long fromPeriod, Long toPeriod) {
	 ...
	 * @return
	 */
	public String fetchContentFromLocalization(RequestInfo requestInfo, String tenantId, String module, String code) {
