...
public class ApplicationProperties {
	...
	private Boolean isEmalNotificationEnabled;
	...
	@Value("${egov.common.host}")
	private String commonHost;
	
	@Value("${egov.common.noAuth.pay.endpoint}")
	private String commonNoAuthPayEndpoint;
	
	@Value("${egov.url.shortening.host}")
	private String urlShorteningHost;
	
	@Value("${egov.url.shortening.noAuth.endpoint}")
	private String urlShorteningNoAuthEndpoint;
