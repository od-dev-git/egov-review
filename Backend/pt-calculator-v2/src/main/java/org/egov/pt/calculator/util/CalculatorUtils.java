...
//            	amountForAccDeatil = detail.getTaxAmount().subtract(detail.getCollectionAmount());
       ...
       /* if(taxAmt.compareTo(collectedAmt) == 0) {
        ...
        return taxAmt.subtract(collectedAmt);
    }
    ...
    public BigDecimal getTaxAmtForDemandForRebateGeneration(Demand demand) {
        ...
        log.info("taxAmt : "+ taxAmt +"for dmd : "+ demand.getId());
        log.info("collectedAmt : "+ collectedAmt +"for dmd : "+ demand.getId());
        log.info("dueAmt before subtraction : "+ dueAmt +"for dmd : "+ demand.getId());
        log.info("adjustedRebateAmount : "+ adjustedRebateAmount +"for dmd : "+ demand.getId());
        
        dueAmt = taxAmt.subtract(collectedAmt) ;
        
        log.info("dueAmt after subtraction : "+ dueAmt +"for dmd : "+ demand.getId());
        ...
        log.info("final dueAmt : "+ dueAmt +"for dmd : "+ demand.getId());
