...
public class ApplicationProperties {
    ...
    @Value("${whatsapp.notification.host}")
    private String whatsAppNotificationHost;

    @Value("${whatsapp.notification.endpoint}")
    private String whatsAppNotificationEndpoint;

    @Value("${whatsapp.notification.brand.msisdn}")
    private String whatsAppNotificationBrandMsisdn;
    
    @Value("${whatsapp.notificationv2.host}")
    private String whatsAppNotificationHostv2;

    @Value("${whatsapp.notificationv2.endpoint}")
    private String whatsAppNotificationEndpointv2;

    @Value("${whatsapp.notificationv2.brand.msisdn}")
    private String whatsAppNotificationBrandMsisdnv2;
