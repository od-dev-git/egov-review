...
//    }
    ...
    @RequestMapping(value = "/{moduleName}/_cancelReceipt", method = RequestMethod.POST)
    @ResponseBody
    public ResponseEntity<?> cancelReceipt(@RequestBody @Valid PaymentWorkflowRequest receiptWorkflowRequest, @PathVariable String moduleName) {

         List<Payment> payments = workflowService.cancelReceipt(receiptWorkflowRequest);
         return getSuccessResponse(payments, receiptWorkflowRequest.getRequestInfo());
     }
