...
public class Payment {
    ...
    @JsonProperty("currentAmountPaid")
    private BigDecimal currentAmountPaid;
    
    @JsonProperty("arrearDue")
    private BigDecimal arrearDue;

    @JsonProperty("arrearAmountPaid")
    private BigDecimal arrearAmountPaid;
    ...
    private String demandPeriod = null;

    @JsonProperty("collectionPeriod")
    private String collectionPeriod = null;

    @JsonProperty("arrearDemandDuration")
    private String arrearDemandDuration = null;
