...
public class PaymentValidator {
    ...
    public Payment validatePaymentForCreate(PaymentRequest paymentRequest) {
        ...
        validateAmount(paymentRequest.getPayment(),errorMap);
...
//            errorMap.put("INVALID_PAYMENTDETAIL", "The amount paid cannot be fractional");
    ...
    private void validateAmount(Payment payment, Map<String, String> errorMap) {
    	if(payment.getTotalAmountPaid().compareTo(BigDecimal.ZERO) <= 0) {
    		errorMap.put("INVALID_PAYMENT_AMOUNT",
