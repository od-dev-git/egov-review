...
@Service
public class LandRegCertificateServiceMultiPlot extends LandRegCertificateService{
    ...
    public static String PARAGRAPH_1 = "Permission under Scheme for regularization of unauthorised layout/subdivided plots, notified in the Extraordinary Gazette no.1034 dated 30 May 2017 7 / Rule 90A of Odisha Development Authorities (Planning & Building Standards) Amendment Rules, 2022; and sub-section (3) of Section 16 of ODA Act, 1982 is hereby granted in favour of Land Owner, ";
    public static String PARAGRAPH_1_2 = "for regularization of unauthorizedly sub-divided plot along with amalgamation of such sub-plots into one single plot ";
    ...
    public static String PARAGRAPH_2_2 = "The permission accorded for regularization of the unauthorizedly sub-divided plot along with amalgamation of such sub-plots into one single plot, cannot be construed as an evidence to claim right, title and interest on the plot on which the permission has been granted.";
    ...
    public static String PARAGRAPH_2_4 = "Application for building plan approval or sub-divisional layout plan approval over the amalgamated plot shall be considered in accordance with the provisions of the land-use specified in the Development Plan and the provisions of Planning & Building Standards Rules/regulations, in operation; and any such provisions applicable at the time of such application.";
    ...
    public static String PARAGRAPH_3_3 = "In the event of any dispute over ownership of road land, BDA shall not be held responsible and party to such dispute; and any development undertaken with private access road on the basis of approval of BDA shall be at the cost and risk of the applicant. ";

    public static String PARAGRAPH_3_4 = "The amalgamated plot shall not be further sub-divided or amalgamated without prior approval u/s-16 of ODA Act, 1982. ";

    public static String PARAGRAPH_3_5 = "No storm water shall be discharged to the public road/public premises and other adjoining plots and shall be discharged to the road side storm water drain.";
    public static String PARAGRAPH_3_6 = "The plinth level of the buildings to be constructed over the regularized plot shall be raised 0.6 meters above the high flood level (HFL).";
    public static String PARAGRAPH_3_7 = "In case the Kisam of plot is not Gharabari, then the applicant shall convert the Kisam of the subdivided plots to “Gharabari” Kisam before selling or utilising or leasing out or otherwise disposing it of; and/or prior to construction of the building.";

    public static String PARAGRAPH_3_8 = "Building construction shall not be permitted, in case, the Kisam of the plot has not been converted to Gharabari. The approval for regularization granted herewith shall neither be construed as approval for conversion of Kisam nor shall confer any right for conversion of Kisam; and the same shall be duly converted to Gharabari kisam in accordance with relevant Rules and Regulations prescribed in this regard.";

    public static String PARAGRAPH_3_9 = "Amalgamation of the sub-plots to form one single plot along with regularization of the sub-divided plot(s) shall not confer any right for construction of building or sub-division of land; and the same shall be considered as per the provision of ODA Act, 1982, Rules / Regulations framed thereunder, provisions of Development Plan, Zoning Regulation and subject to applicable statutory provisions of the State / Central Government.";
    public static String PARAGRAPH_3_10 = "Regularization of the sub-divided plot shall not give any right for means of access/easement right to the plot.";

    public static String PARAGRAPH_3_11 = "In case of deficit external infrastructure, the applicant shall obtain NOC from the concerned local authority in respect of the external Infrastructure, at the time of building /sub-divisional layout plan application.";

    public static String PARAGRAPH_3_12 = "Any NOC required from any public agency / competent authority for the purpose of undertaking development over the approved/regularized plot shall be obtained by the applicant prior to undertaking development over such plot.";

    public static String PARAGRAPH_3_13 = "Prior approval of the Authority shall be taken before undertaking any development over the amalgamated plot; and in case, any development is undertaken over the amalgamated plot without prior approval of the Authority, then the permission so granted shall be automatically treated as cancelled.";
    ...
    public InputStream createPdf(LinkedHashMap regularizations, RequestInfo requestInfo, Boolean isPreview)
        ...
        String giftedPlotArea = getAreaTobeGifted(regularizations);
        ...
        ListItem list2Item9 = new ListItem();
        list2Item9.add(new Phrase(PARAGRAPH_3_9, font1));
        list2Item9.add(Chunk.NEWLINE);
        list2Item9.setAlignment(List.ALIGN_JUSTIFIED);
        list2Item9.setSpacingAfter(10);
        list2.add(list2Item9);

        ListItem list2Item10 = new ListItem();
        list2Item10.add(new Phrase(PARAGRAPH_3_10, font1));
        list2Item10.add(Chunk.NEWLINE);
        list2Item10.setAlignment(List.ALIGN_JUSTIFIED);
        list2Item10.setSpacingAfter(10);
        list2.add(list2Item10);

        ListItem list2Item11 = new ListItem();
        list2Item11.add(new Phrase(PARAGRAPH_3_11, font1));
        list2Item11.add(Chunk.NEWLINE);
        list2Item11.setAlignment(List.ALIGN_JUSTIFIED);
        list2Item11.setSpacingAfter(10);
        list2.add(list2Item11);

        ListItem list2Item12 = new ListItem();
        list2Item12.add(new Phrase(PARAGRAPH_3_12, font1));
        list2Item12.add(Chunk.NEWLINE);
        list2Item12.setAlignment(List.ALIGN_JUSTIFIED);
        list2Item12.setSpacingAfter(10);
        list2.add(list2Item12);

        ListItem list2Item13 = new ListItem();
        list2Item13.add(new Phrase(PARAGRAPH_3_13, font1));
        list2Item13.add(Chunk.NEWLINE);
        list2Item13.setAlignment(List.ALIGN_JUSTIFIED);
        list2Item13.setSpacingAfter(10);
        list2.add(list2Item13);
...
//		areaStatementTable.setWidthPercentage(100f);
        ...
        areaStatementTable.addCell(getNetPlotArea(regularizations)+" sq. meter");

        ListItem areaStatementItem = new ListItem();
        areaStatementItem.add(new Chunk("Area statement of the amalgamated plot", fontBold));
