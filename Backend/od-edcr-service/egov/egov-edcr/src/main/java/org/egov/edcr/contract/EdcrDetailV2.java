...
public class EdcrDetailV2 {
    ...
    private PlanResponseDTO planDetail;
    ...
    private Object gisData;
    
    private String dxfToPdfBase;
    
    private String dxfToPdfBasePlusObpas;
    ...
    public void setPlanDetail(PlanResponseDTO planDetail) {
	...
	public Object getGisData() {
		return gisData;
	}

	public void setGisData(Object gisData) {
		this.gisData = gisData;
	}

	public String getDxfToPdfBase() {
		return dxfToPdfBase;
	}

	public void setDxfToPdfBase(String dxfToPdfId1) {
		this.dxfToPdfBase = dxfToPdfId1;
	}

	public String getDxfToPdfBasePlusObpas() {
		return dxfToPdfBasePlusObpas;
	}

	public void setDxfToPdfBasePlusObpas(String dxfToPdfId2) {
		this.dxfToPdfBasePlusObpas = dxfToPdfId2;
	}
