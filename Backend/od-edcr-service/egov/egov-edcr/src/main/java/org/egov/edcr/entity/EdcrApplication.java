...
public class EdcrApplication extends AbstractAuditable {
    ...
    private transient List<TechnicalPersonRole> roles;
    
    private transient Boolean isCadToPdfEnabled;
	...
	public Boolean getIsCadToPdfEnabled() {
		return isCadToPdfEnabled;
	}

	public void setIsCadToPdfEnabled(Boolean isCadToPdfEnabled) {
		this.isCadToPdfEnabled = isCadToPdfEnabled;
	}
