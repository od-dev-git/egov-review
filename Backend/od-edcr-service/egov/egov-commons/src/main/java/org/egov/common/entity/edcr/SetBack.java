...
public class SetBack implements Serializable {
    ...
    private Yard frontYardOverride;
    private Yard rearYardOverride;
    private Yard sideYard1Override;
    private Yard sideYard2Override;
	...
	public Yard getFrontYardOverride() {
		return frontYardOverride;
	}

	public Yard getRearYardOverride() {
		return rearYardOverride;
	}

	public Yard getSideYard1Override() {
		return sideYard1Override;
	}

	public Yard getSideYard2Override() {
		return sideYard2Override;
	}

	public void setFrontYardOverride(Yard frontYardOverride) {
		this.frontYardOverride = frontYardOverride;
	}

	public void setRearYardOverride(Yard rearYardOverride) {
		this.rearYardOverride = rearYardOverride;
	}

	public void setSideYard1Override(Yard sideYard1Override) {
		this.sideYard1Override = sideYard1Override;
	}

	public void setSideYard2Override(Yard sideYard2Override) {
		this.sideYard2Override = sideYard2Override;
	}
