...
public class Plan implements Serializable {
	...
	/**
	 * Plan scrutiny report status. Values true mean "Accepted" and False mean "Not
	 * Accepted". Default value false. On plan scrutiny, if all the rules are
	...
	// Records Accessory building details. Building has outdoor structures such as
	// attached or detached garages, sheds, storage
	...
	// Temporary building object used to validate rules based on overall
	// plot/buildings details. Eg: Total buildup area of all the
	...
	// Parking facilities provided in the plot. Includes visitor, two wheeler, four
	// wheeler etc
	...
	// Utilities of building like solar,waste disposal plant, watertank, rain water
	// harvesting etc
	...
	// Segregated toilet facilities for visitors in Public Buildings (within the
	// premises of the building, but outside the
	// building block)
	...
	// For proposed road widening, surrendered road area.This area will be used to
	// calculate FAR,setback and permissible buildup
	// area.
	private transient BigDecimal totalSurrenderRoadArea = BigDecimal.ZERO;
	// Distance of plot with external entities like rive, lake, monuments,
	// government building etc are grouped.
	...
	@Transient
	@JsonIgnore
	private List<EdcrPdfDetail> edcrPdfDetails1;
	@Transient
	@JsonIgnore
    private List<EdcrPdfDetail> edcrPdfDetails2;
	...
	/**
	 * The report output object. Based on type of building and occupancies,the rules
	 * are validated and rules which are considered for the submitted plan are
	...
	private List<Block> ictBlocks = new ArrayList<>();
	
	private List<ICT> icts = new ArrayList<>();
	
	private Ammenity ammenity;
	
	private transient Boolean isDxfToPdfEnabled;
	
	//AffectedLandArea area in plot
	private  List<AffectedLandArea> affectedLandAreas=new ArrayList<>();
	
	private EvCharging evCharging = new EvCharging();
	
	private List<TechnicalPersonRole> roles;
	...
	public List<Block> getIctBlocks() {
		return ictBlocks;
	}

	public void setIctBlocks(List<Block> icts) {
		this.ictBlocks = icts;
	}
	...
	public EvCharging getEvCharging() {
		return evCharging;
	}

	public void setEvCharging(EvCharging evCharging) {
		this.evCharging = evCharging;
	}

	public List<TechnicalPersonRole> getRoles() {
		return roles;
	}

	public void setRoles(List<TechnicalPersonRole> roles) {
		this.roles = roles;
	}

	public List<EdcrPdfDetail> getEdcrPdfDetails1() {
		return edcrPdfDetails1;
	}

	public void setEdcrPdfDetails1(List<EdcrPdfDetail> edcrPdfDetails1) {
		this.edcrPdfDetails1 = edcrPdfDetails1;
	}

	public List<EdcrPdfDetail> getEdcrPdfDetails2() {
		return edcrPdfDetails2;
	}

	public void setEdcrPdfDetails2(List<EdcrPdfDetail> edcrPdfDetails2) {
		this.edcrPdfDetails2 = edcrPdfDetails2;
	}
