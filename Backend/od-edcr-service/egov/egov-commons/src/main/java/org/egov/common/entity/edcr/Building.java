...
public class Building extends Measurement {
    ...
    private Boolean heightDeducted = false;
	...
	public Boolean getHeightDeducted() {
		return heightDeducted;
	}

	public void setHeightDeducted(Boolean heightDeducted) {
		this.heightDeducted = heightDeducted;
	}
