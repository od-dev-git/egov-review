...
public class Block extends Measurement {
    ...
    private List<BigDecimal> distFromExtWall;
    private boolean ict;
	...
	public List<BigDecimal> getDistFromExtWall() {
		return distFromExtWall;
	}

	public void setDistFromExtWall(List<BigDecimal> distFromExtWall) {
		this.distFromExtWall = distFromExtWall;
	}
