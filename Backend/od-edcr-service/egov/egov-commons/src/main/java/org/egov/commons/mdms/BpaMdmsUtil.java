...
public class BpaMdmsUtil {
    ...
    public List<ModuleDetail> getBPAModuleRequest() {
        ...
        MasterDetail masterDetailGISLandUse = new MasterDetail();
        masterDetailGISLandUse.setName("GISLandUse");
        bpaMasterDtls.add(masterDetailGISLandUse);
        
        MasterDetail masterDetailConstructionRate = new MasterDetail();
        masterDetailConstructionRate.setName("ConstructionCostRate");
        bpaMasterDtls.add(masterDetailConstructionRate);
