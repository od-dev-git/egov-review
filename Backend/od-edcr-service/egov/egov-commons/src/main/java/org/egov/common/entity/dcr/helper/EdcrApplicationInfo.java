...
public class EdcrApplicationInfo implements Serializable {
    ...
    private String baseLayerFileStoreId;
	...
	public String getBaseLayerFileStoreId() {
		return baseLayerFileStoreId;
	}

	public void setBaseLayerFileStoreId(String baseLayerFileStoreId) {
		this.baseLayerFileStoreId = baseLayerFileStoreId;
	}
}
