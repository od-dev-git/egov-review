...
public class EdcrPdfDetail implements Serializable {
    ...
    @Transient
    private FileStoreMapper convertedFileStoreMapper;
    
    @Transient
    private ByteArrayOutputStream pdfByteArrayOutputStream;
    
    private File tempFile;

    public ByteArrayOutputStream getPdfByteArrayOutputStream() {
        return pdfByteArrayOutputStream;
    }

    public void setPdfByteArrayOutputStream(ByteArrayOutputStream pdfStream) {
        this.pdfByteArrayOutputStream = pdfStream;
    }
    ...
    public FileStoreMapper getConvertedFileStoreMapper() {
        return convertedFileStoreMapper;
    }
    
    public void setConvertedFileStoreMapper(FileStoreMapper fileStoreMapper) {
        this.convertedFileStoreMapper = fileStoreMapper;
    }
