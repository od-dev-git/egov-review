...
public class Occupancy extends Measurement {
    ...
    private BigDecimal builtUpAreaAdd = BigDecimal.ZERO;
    ...
    private BigDecimal existingBuiltUpAreaAdd = BigDecimal.ZERO;
    ...
    private BigDecimal farAreaDeduct = BigDecimal.ZERO;
    private BigDecimal farAreaDeductExisting = BigDecimal.ZERO;
    ...
    public BigDecimal getBuiltUpAreaAdd() {
		return builtUpAreaAdd;
	}

	public void setBuiltUpAreaAdd(BigDecimal builtUpAreaAdd) {
		this.builtUpAreaAdd = builtUpAreaAdd;
	}

	public BigDecimal getExistingBuiltUpAreaAdd() {
		return existingBuiltUpAreaAdd;
	}

	public void setExistingBuiltUpAreaAdd(BigDecimal existingBuiltUpAreaAdd) {
		this.existingBuiltUpAreaAdd = existingBuiltUpAreaAdd;
	}
	...
	public BigDecimal getFarAreaDeduct() {
		return farAreaDeduct;
	}

	public void setFarAreaDeduct(BigDecimal farAreaDeduct) {
		this.farAreaDeduct = farAreaDeduct;
	}

	public BigDecimal getFarAreaDeductExisting() {
		return farAreaDeductExisting;
	}

	public void setFarAreaDeductExisting(BigDecimal farAreaDeductExisting) {
		this.farAreaDeductExisting = farAreaDeductExisting;
	}
