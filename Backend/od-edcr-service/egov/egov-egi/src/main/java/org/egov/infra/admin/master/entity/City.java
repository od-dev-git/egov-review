...
public class City extends AbstractAuditable {
	...
	public String toString() {
		return "City [id=" + id + ", name=" + name + ", localName=" + localName + ", active=" + active + ", domainURL="
				+ domainURL + ", code=" + code + ", districtCode=" + districtCode + ", districtName=" + districtName
				+ ", regionName=" + regionName + ", grade=" + grade + ", longitude=" + longitude + ", latitude="
				+ latitude + ", preferences=" + preferences + ", tenantId=" + tenantId + "]";
	}
