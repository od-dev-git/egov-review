...
//            LOG.info("connection.getMetaData() inside getConnection : "+ connection.getMetaData());
...
//    	System.out.println("releaseConnection : tenantId "+tenantId);   	
        try {
//        	LOG.info("releaseConnection -> connection.setSchema : "+tenantId);       	
            connection.setSchema(tenantId);
        } catch (SQLException e) {
            LOG.warn("Error occurred while switching schema upon release connection", e);
        }
//        LOG.info("connection.getMetaData() inside releaseConnection: "+ connection.getMetaData());
//        LOG.info("After release of connection : "+ connection.getSchema());
