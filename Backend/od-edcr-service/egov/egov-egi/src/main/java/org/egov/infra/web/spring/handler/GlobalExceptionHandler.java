...
import org.egov.infra.exception.CustomResourceAccessException;
import org.egov.infra.exception.CustomUnknownHostException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CustomResourceAccessException.class)
    public ResponseEntity<ErrorResponse> handleResourceAccessException(CustomResourceAccessException ex) {
        ErrorResponse errorResponse = new ErrorResponse("SERVICE_UNAVAILABLE", ex.getMessage(), HttpStatus.SERVICE_UNAVAILABLE);
        return new ResponseEntity<>(errorResponse, HttpStatus.SERVICE_UNAVAILABLE);
    }
    
    @ExceptionHandler(CustomUnknownHostException.class)
    public ResponseEntity<ErrorResponse> handleUnknownHostException(CustomUnknownHostException ex) {
        ErrorResponse errorResponse = new ErrorResponse("SERVICE_UNAVAILABLE", ex.getMessage(), HttpStatus.SERVICE_UNAVAILABLE);
        return new ResponseEntity<>(errorResponse, HttpStatus.SERVICE_UNAVAILABLE);
    }
}
