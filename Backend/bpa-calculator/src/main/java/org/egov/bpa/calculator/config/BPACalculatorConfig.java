...
public class BPACalculatorConfig {
    ...
    @Value("${egov.calculate.exemptionfee.outsidesujog}")
    private Boolean calculateExemptionForFeeOutsideSujogAppl;
...
//    Kafka Topics
	...
	@Value("${egov.collection.service.search.regPermitFee.endpoint}")
	private String collectionServiceSearchRegularizationPermitFeeEndpoint;
...
//    private String defaultAccessoryCalculationType;
	...
	@Value("${regularization.search.endpoint}")
	private String regularizationSearchEndpoint;
	
	@Value("${egov.demand.regularization.appl.businessservice}")
	private String regularizationAppFeeBusinessService;
	
	@Value("${egov.demand.regularization.sanc.businessservice}")
	private String regularizationSancFeeBusinessService;
	
	@Value("${demolition.search.endpoint}")
	private String demolitionSearchEndpoint;
	
	@Value("${egov.demand.demolition.businessservice}")
	private String demolitionBusinessServie;
