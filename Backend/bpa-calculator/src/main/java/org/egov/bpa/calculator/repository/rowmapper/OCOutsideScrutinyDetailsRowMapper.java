...
import org.egov.bpa.calculator.web.models.oc.BuildingBlockDetails;
import org.egov.bpa.calculator.web.models.oc.Fee;
import org.egov.bpa.calculator.web.models.oc.PlotDetails;
    ...
    public List<ScrutinyDetails> extractData(ResultSet rs) throws SQLException, DataAccessException {
        ...
        while(rs.next()){
        	ScrutinyDetails scrutinyDetails = ScrutinyDetails.builder()
                    ...
                    .occupancyTypeHelperCode(rs.getString("occupancyTypeHelperCode"))
                    .occupancySubTypeHelperCode(rs.getString("occupancySubTypeHelperCode")).build();
            ...
            if(plotArea!=null && giftedLandArea!=null)
            	plotDetails.setGiftedLandArea(plotArea.subtract(giftedLandArea));
            ...
            scrutinyDetailsList.add(scrutinyDetails);
